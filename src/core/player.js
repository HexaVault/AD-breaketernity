...
window.player = {
  ...
  celestials: {
    ...
    pelle: {
      ...
      rebuyables: {
        antimatterDimensionMult: new Decimal(),
        timeSpeedMult: new Decimal(),
        glyphLevels: new Decimal(),
        infConversion: new Decimal(),
        galaxyPower: new Decimal(),
        galaxyGeneratorAdditive: new Decimal(),
        galaxyGeneratorMultiplicative: new Decimal(),
        galaxyGeneratorAntimatterMult: 0,
        galaxyGeneratorIPMult: new Decimal(),
        galaxyGeneratorEPMult: new Decimal(),
      },
      rifts: {
        vacuum: {
          fill: DC.D0,
